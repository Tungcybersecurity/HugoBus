...
namespace GUI.PhanCong_DiemDanh
{
    public partial class PhanCong_DiemDanh : Form
    {
        ...
        {
            DateTime startDate = DateTime.Parse(DateTime.ParseExact(NgayBatDau_CPC, "dd/MM/yyyy hh:mm:ss tt", new CultureInfo("vi-VN")).ToString("yyyy-MM-dd"));
            DateTime endDate = DateTime.Parse(DateTime.ParseExact(NgayKetThuc_CPC, "dd/MM/yyyy hh:mm:ss tt", new CultureInfo("vi-VN")).ToString("yyyy-MM-dd"));
