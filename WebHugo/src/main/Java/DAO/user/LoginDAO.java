...
public class LoginDAO extends GetConnection {
   ...
   public InFoAccount dangNhap(Account a)
   {
       ...
       if(con!=null)
       {
           try {
               ...
               if(rs.next())
               {
                   pa= ModelMapper.mapResultSetToObject(rs,InFoAccount.class);
               }
               return pa;
   ...
   public String getPhanQuyen(Account a)
   {
       Connection con=getConnection();
       String tendangnhap=layTenDangNhap(a);
       String sql="select PhanQuyen from taikhoanphuhuynh where TenDangNhap=?";
       PreparedStatement pr=null;
       ResultSet rs=null;
       if(con!=null)
       {
